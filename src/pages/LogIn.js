      ...
      <div className="login-section max-w-[1380px] mx-auto">
        <div className="mx-auto max-w-[400px] sm:max-w-[500px] md:max-w-[700px] p-[20px]">
          <form className="flex flex-col justify-evenly py-[30px] rounded-md my-[30px]">
            <h1 className="login-h1 text-2xl mx-auto my-[10px]">Login</h1>
            <input
              type="text"
            ...
            <div className="flex justify-center px-[20px]">
              <h3 className="text-white mx-[10px]">haven't an account ?</h3>
              <Link to="/signup" className="text-white hover:text-orange-800">
                SignUp
              </Link>
            </div>
          </form>
